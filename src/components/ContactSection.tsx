...
const ContactSection = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "otaryan.anahit03@gmail.com", href: "mailto:otaryan.anahit03@gmail.com" },
    { icon: Phone, label: "Phone", value: "+374 33 35 34 58", href: "tel:+15551234567" },
  ...
  return (
    <section id="contact" className="py-32 relative" ref={ref}>
      ...
      <div className="section-container">
        ...
        >
          <span className="code-block mb-4 inline-block">{"// Contact"}</span>
          <h2 className="text-4xl lg:text-5xl font-display font-bold">
            Let's <span className="gradient-text">Connect</span>
          </h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
         Interested in collaboration or have a proposal? I’m always open to discussing new ideas and professional opportunities.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <form onSubmit={handleSubmit} className="glass-card p-8 rounded-2xl">
              <div className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-4 rounded-lg font-display font-semibold text-primary-foreground flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.02] glow-effect"
          ...
          >
            ...
            <div className="glass-card p-8 rounded-2xl text-center">
              <p className="font-mono text-sm text-muted-foreground mb-2">Currently available for</p>
              <p className="text-xl font-display font-bold gradient-text">Freelance & Full-time</p>
            </div>
          </motion.div>
        </div>
      </div>
