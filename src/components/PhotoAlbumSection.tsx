...
const PhotoAlbumSection = () => {
  ...
  const isCertInView = useInView(certRef, { once: true, margin: "-120px" });
  ...
  const photos = [
    { id: 1, url: "/assets/labs.jpg", caption: "42 Yerevan Internatioonal School" },
    { id: 2, url: "/assets/geo.jpg", caption: "Erasmus + Georgia Bakurani" },
    { id: 3, url: "/assets/lasbs.jpg", caption: "42 Yerevan Internatioonal School" },
    { id: 4, url: "/assets/bug.jpg", caption: "Yerevan Bug Bounty" },
    { id: 5, url: "/assets/rrr.jpg", caption: "Erasmus + Georgia Bakurani" },
    { id: 6, url: "/assets/qe.jpg", caption: "42 Yerevan Internatioonal School" },
    { id: 7, url: "/assets/math.jpg", caption: "Russian Armenian University" },
    { id: 8, url: "/assets/bou.jpg", caption: "Russian Armenian University" },
  ];
  ...
  const certificates = [
    {
      id: 1,
      url: "/bugcert.jpg",
      title: "Bug Bounty Chalange",
    },
    {
      id: 2,
      url: "/assets/link.jpg",
      title: "C++  Programming Linkedin Learning",
    },
  ];
  ...
  return (
    <>
      {/* PHOTO ALBUM */}
      <section id="gallery" ref={ref} className="py-36 relative overflow-hidden">
          ...
          >
            {certificates.map((cert) => (
              <motion.div
                ...
                transition={{ duration: 0.4 }}
                className="relative rounded-2xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur-xl p-4 shadow-[0_0_60px_-15px_rgba(99,102,241,0.35)]"
              >
                <img
                  src={cert.url}
                  alt={cert.title}
